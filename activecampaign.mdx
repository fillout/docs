...
To add a tag to specific contacts, toggle the `Add conditionally?` switch. `Set conditional logic` and choose when to apply it. For example, we'll add the "New" tag when a customer hasn't been part of our waitlist before.
