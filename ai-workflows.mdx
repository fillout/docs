...
Get a summary of the form submission or a specific set of answers. You can opt for `Custom` and reference only summaries to fields you'd like to see. Click <Icon icon="square-plus" iconType="solid" /> or type **@**.
