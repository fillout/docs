...
In your heading or paragraph, type **@**. Then, click <Icon icon="database" /> followed by `Updating records` to choose the field you'd like to display.
...
<CardGroup cols={3}>
  ...
  <Card color="#FFC738" icon="input-text" iconType="regular" href="/placeholder" title="Placeholders">
