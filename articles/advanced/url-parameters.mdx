...
![Screenshot2025 02 05at2 33 53PM Pn](/images/Screenshot2025-02-05at2.33.53PM.png)

Enter a **Parameter name**. Here, we can tell Fillout to expect a URL Parameter with a certain name.

<Note>
  Note that you can optionally provide a sample value for the parameter, if you’d like to see what your form looks like with that value being used (e.g. if you have some [hide/show logic](https://www.notion.so/Conditionally-hide-fields-dc375019d2cc42b18b96f9280c607f21?pvs=21) based on it).
</Note>
...
- [Pre-fill a field](https://www.notion.so/Pre-fill-fields-d10c479c53c24d0e8f6922cf6bbf785c?pvs=21), by pressing the `+` icon on a **Default value** property of any field
...
![Screenshot2024 06 26at6 10 16PM Pn](/images/Screenshot2024-06-26at6.10.16PM.png)

`Publish` your form and share it to your respondents.

![Screen Shot2023 11 14at3 31 07PM Pn](/images/ScreenShot2023-11-14at3.31.07PM.png)
...
![Screenshot2025 02 05at2 40 28PM Pn](/images/Screenshot2025-02-05at2.40.28PM.png)

b. Head to your integration settings, and map the URL parameter directly. E.g. for Airtable, there is a **Mappings** section which you can use for this purpose. See [this article](https://www.notion.so/Map-Fillout-fields-to-integrations-abc240edf1c1404c8c7b4b182545ea10?pvs=21) for more information.
