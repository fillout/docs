...
![Screenshot2025 02 17at10 44 28AM Pn](/images/Screenshot2025-02-17at10.44.28AM.png)
...
![Screenshot2025 02 17at10 42 43AM Pn](/images/Screenshot2025-02-17at10.42.43AM.png)
...
![Screenshot2025 02 17at10 43 11AM Pn](/images/Screenshot2025-02-17at10.43.11AM.png)
...
You can choose to generate docs only under a specified condition. Check out this [quick guide](https://www.notion.so/Conditional-integration-logic-180148986f5d47b981b5de5580b00169?pvs=21).
...
<CardGroup cols={3}>
  ...
  <Card title="Create a Google Sheets form" icon="file-spreadsheet" iconType="regular" color="#FFC738">
    Sync responses from your Fillout form to a Google Sheet in under 30 seconds.
  </Card>
  <Card title="Track data with Google Tag Manager" icon="tags" iconType="regular" color="#FFC738">
