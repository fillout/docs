...
| `org.aiFeaturesDisabled` | AI features were turned off or back on for the organization. Payload includes the new value. | <Icon icon="shield-halved" size={16} /> |
| `org.ssoRequireInvite` | The requirement for an invitation to join via SSO was toggled. Payload includes whether it was enabled or disabled. | <Icon icon="shield-halved" size={16} /> |
