...
Take note that the default is set to `Show when` and **equals**, which means a banner will appear when a certain option is selected. Alternatively, you can [**conditionally hide fields**](/conditional-hiding) and [**add condition groups**](/condition-logic-groups).
