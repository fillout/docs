...
**Build calculations with AI**

Need to set up calculations quickly? You can ask **Form Agent** to help you create calculations for your form. Learn more [here](https://www.fillout.com/help/form-agent).
...
Fillout automatically computes the score and lets you [display it on any page](https://www.fillout.com/help/make-a-free-quiz#advanced-quiz-features) you prefer. Additionally, you can [use weighted scoring](https://www.fillout.com/help/make-a-free-quiz#advanced-quiz-features), which also lets you [assign results based on total score](https://www.fillout.com/help/outcome-quiz#assign-results-based-on-total-score).
