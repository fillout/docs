...
Finally, pass the record ID to update to the update form. Click `Set URL parameters` to choose the `ID` parameter of your update form and map it to your record picker field’s `Record ID`.
