...
<Steps>
  ...
  <Step title="Set views (if needed)">
    Depending on the type of collaborative form you are creating, you may need to have different views for different roles. You can request this change in the chat. As seen in our example below, we are logged as the copywriter, which prevents us form uploading an artwork.
  </Step>
  <Step title="New Step">
