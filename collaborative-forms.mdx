...
<Note>
 Collaborative form editing is not currently available natively in Fillout, but you can create collaborative forms with our app builder, Zite. Fillout users automatically get a free Zite plan with a set number of credits (which you can increase by upgrading your plan).
</Note>
