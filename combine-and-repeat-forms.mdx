...
First, make sure you've registered the URL parameter in the new form to redirect to. Check out the steps [here](/url-parameters). Then, click `+ Add new` in the popup to set a URL parameter.
