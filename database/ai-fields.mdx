...
<Warning>
Web search uses additional AI credits per generation.
</Warning>
...
AI autofill uses AI credits from your account balance. Before a bulk generation starts, the system checks that you have enough AI credits. If AI credits run out mid-batch, cells that already finished keep their values.

Web search-enabled generations use additional AI credits.
