...
<Steps>
  ...
  Click the database from the home page [dashboard](https://build.fillout.com/home).
  </Step>
...
All endpoints are limited to being called no more than 30 times per second, per Account/API key. Contact support@fillout.com if you need increased rate limits.
