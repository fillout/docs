---
title: "Zite Database Field Types"
...
<Note>
  Formula fields are read-only and automatically recalculate when referenced fields change. See the [Formulas guide](/database/formulas) for the complete list of supported functions.
</Note>
...
| ------------ | ------ | -------------------------------------------------------------------------- |
| `expression` | string | The [formula expression](/database/formulas), e.g. `"SUM({Price}, {Tax})"` |
