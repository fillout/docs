...
Typically, a form loads with empty fields. With pre-fetching, the form first looks up data from your database using an identifier (like an email), then loads with fields already populated. 
...
<Steps>
  <Step title="Connect to Zite Database">
    Open your Fillout form and click `Integrate` on top to [link it to your Zite Database](https://www.fillout.com/help/database/sync-form-results#link-your-form-to-a-zite-database).
  </Step>
  ...
  <Step title="Test fetch">
    ...
    Choose a database column from the left, then match this a [url parameter](https://www.fillout.com/help/url-parameters) or static value on the right . This condition is how the form identifies which record to fetch.
  ...
  <Step title="Publish and share">
    ...
    \
    That's it! When users open this link, the form will load with their data already filled in.
  </Step>
</Steps>