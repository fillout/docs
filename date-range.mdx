...
<Steps>
  <Step title="Add a Date field">
    Follow the [steps above](/date-range#how-to-add-a-date-field).
  </Step>
  <Step title="Select an integration">
    Click `Integrate` in top menu and choose [Airtable](https://www.fillout.com/help/airtable), [Notion](https://www.fillout.com/help/notion) or another [database](https://www.fillout.com/help/integrations#spreadsheet-%26-database). In this example, we’ll use Airtable.
  </Step>
