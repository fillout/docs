...
<Check>
  Editing form submissions automatically updates data synced through [**integrations**](/integrations). This will update existing records in Airtable or Notion, send new alerts on Slack, update Dropbox folders, etc.
</Check>
