...
<Steps>
  ...
  <Step title="Paste Fillout embed code">
    You'll see an `Embed your custom code here` text. Paste the code there.
...
<CardGroup cols={3}>
  <Card title="Pick from linked records" color="#FFC738" icon="folder" iconType="regular" href="/select-linked-airtable-records">
    Let respondents select linked records.
  </Card>

  <Card title="Embed parameters" color="#FFC738" icon="brackets-square" iconType="regular" href="/embedded-url-parameters">
