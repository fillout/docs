...
icon: "rotate"
sidebarTitle: "External Dependencies"
---
...
From the dashboard, click your `Account name` in the upper left corner followed by `Fillout Enterprise`. Navigate to **Form dependencies** on the top menu. Here, you’ll see a list of every external field that your forms rely on.
