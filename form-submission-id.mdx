...
A unique **Submission ID** is generated whenever someone begins to complete your form. Submission IDs are randomly generated, like 6bcedd3a-fe26-4bcb-9ce9-d3850e38d42c.
...
<Steps>
  <Step title="Select your integration">
    First, navigate to the `Integrate` tab located on the top menu, and choose the app or service you would like to use.
  </Step>
...
Hover and click <Icon icon="arrow-up-right-and-arrow-down-left-from-center" size={15} /> on the result you are interested in. You'll see the **Submission ID** at the bottom of the window on the right side.
