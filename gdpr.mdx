...
Fillout is engineered to keep your data secure and private. For our customers and users in Europe, **Fillout is GDPR-ready**, and offers EU-based hosting and storage for respondent data (form submissions) on the Team plan and above.

<Info>
  Fillout offers EU-based hosting and storage for all respondent data (form submissions) on our [Team plan](/team-plan) and above. [Contact support](mailto:support@fillout.com) to switch to EU hosting after upgrading.
</Info>

## What is GDPR?

The European Union’s [General Data Protection Regulation](https://commission.europa.eu/law/law-topic/data-protection/data-protection-eu_en), or **GDPR**, is a data protection regulation built around the EU Charter of Fundamental Rights’ stipulation that EU citizens have the right to the protection of their personal data. In short, GDPR stipulates that you obtain consent before collecting personal data, that you give users their data and delete it if requested to do so, and that Europeans’ data is stored only inside the EU.
...
If you are an EU resident and would like to make use of your GDPR data privacy rights, please contact [Prighter](https://prighter.com/q/11880772674), our privacy representative in the EU.

**Security**

Fillout is hosted on Amazon Web Services (AWS), via [Render.com](https://render.com/), with AWS's industry-leading security. Fillout encrypts all data in transit between you or your form respondents and Fillout’s servers over HTTPS/TLS. Data is also encrypted at rest and replicated for durability.
...
Every Fillout form includes a CSV spreadsheet that you can export. Click `Results` on the top menu bar followed by <Icon icon="arrow-down-to-line" /> to download the CSV.

<img
  src="/images/Screenshot2025-10-07at4.38.58PM.png.avif"
  alt="Screenshot2025-10-07at4.38.58PM.png.avif"
  title="Screenshot2025-10-07at4.38.58PM.png.avif"
  style={{ width:"53%" }}
/>

Anyone who has filled out a Fillout-powered form can contact the form creator and ask them for a copy of their submission. Alternatively, contact Fillout at [privacy@fillout.com](mailto:privacy@fillout.com) and we’ll assist you in contacting the form owner.

## How to remove my data from Fillout

If you’re a Fillout user, you can delete your data in several ways:

- **Delete a form** - look for your form in the dashboard and click **⋯** to `Move to trash`. This also deletes responses collected.
- [**Delete an individual form response**](https://www.fillout.com/help/delete-a-form-submission#delete-submissions) - in the `Results` page of your form, click the cell containing their response followed by `Delete row`. 
- [**Delete your Fillout account**](https://www.fillout.com/help/delete-user-account) - in your `Account settings`, scroll down to `Delete account`.

If you’ve filled out a Fillout-powered form and would like to remove your data, please contact the form creator and ask them to delete your data. Alternatively, contact Fillout at [privacy@fillout.com](mailto:privacy@fillout.com) and we’ll assist you in contacting the form owner.
...
<img
  src="/images/security-&-legal/image-1.png"
  alt="Fillout GDPR"
  style={{ width:"81%" }}
/>
...
If your business needs to store all respondent data within the EU, upgrade to the [Team plan](/team-plan) or above and contact support after upgrading to switch to EU-based hosting. For additional features like single sign-on, check out our [Enterprise plan](https://main.fillout.com/enterprise).

## Related article

<CardGroup cols={3}>
  <Card title="Subprocessors" icon="panel-ews" iconType="regular" color="#FFC738" href="/subprocessors">
    What we use for data processing and integrations.
  </Card>
</CardGroup>
