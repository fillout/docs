...
<Steps>
  ...
  <Step title="Select a folder and set a format">
    ...
    <Note>
      Connecting to a **shared folder** (Shared with me) isn't currently supported. Only folders under **My Drive** can be connected. Select an existing folder there or create a new one.
    </Note>
