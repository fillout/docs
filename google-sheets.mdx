...
<Steps>
  ...
  <Step title="View the spreadsheet">
    ...
    Every question or field in your form will automatically become a column in your sheet.
...
<CardGroup cols={3}>
  <Card title="Sync form responses to Microsoft Excel" color="#FFC738" icon="file-excel" iconType="regular" href="/microsoft-excel">
