...
To limit which team members can access which integrations, log in as an admin. From your dashboard, click your `Account name` and head to `Integrations`. More info [here](/manage-integrations).
