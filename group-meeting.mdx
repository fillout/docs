...
<Steps>
  ...
  <Step title="Publish and share">
    ...
    <Note>
      Group meeting notifications are sent from the Fillout Notifications email instead of Google Calendar, so they won't be automatically suggested in your calendar.
    </Note>
  </Step>
</Steps>
