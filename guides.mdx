...
<CardGroup cols={2}>
  ...
  <Card title="Improve form accessibility" icon="ear" iconType="regular" color="#FFC738" href="/forms-accessibility">
  ...
  <Card title="Display a cookie banner" icon="cookie" iconType="regular" color="#FFC738" href="/cookie-banner">
