---
title: "Add headings to your form"
...
<CardGroup cols={3}>
  ...
  <Card title="Add links" color="#FFC738" icon="link" iconType="regular" href="/add-links-to-form">
    Add URLs in your form to link to external websites or services.
  </Card>

  <Card title="Add images or GIFs" color="#FFC738" icon="image" iconType="regular" href="/image-gif">
