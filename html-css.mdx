...
## How does the HTML field work?

The HTML field lets you add a custom HTML block to any part of your form, including custom CSS and custom Javascript code.

<Info>
  This feature is available on the **Business**, **Team**, and **Enterprise** plans. Learn more about our pricing plans and advanced features [**here**](https://www.fillout.com/pricing).
</Info>

## How to add an HTML field
