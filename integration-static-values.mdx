...
<Steps>
  ...
  <Step title="Map your form fields on Fillout">
    Go to the **Mappings** section and link Airtable (or Notion) fields on the left to the Fillout fields on the right. In our example, we'll choose the Status field on Airtable.
