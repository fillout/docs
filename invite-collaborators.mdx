...
<Warning>
  The <strong>Member</strong> role is available on the [Team](/team-plan) and Enterprise plans.
</Warning>
...
Sharing individual forms is available on the [Team](/team-plan) and Enterprise plans.
On other plans, you can only add admins to your organization.
