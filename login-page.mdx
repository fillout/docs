...
Limit logins to users listed in a specific database, and retrieve their records for use in the form. On the left-hand panel, toggle `Connect to database` and choose your **Base** and **Users table**.

<img
  src="/images/Screenshot-2026-04-22-at-6.19.27-PM.png"
  alt="Screenshot 2026 04 22 At 6 19 27 PM"
  title="Screenshot 2026 04 22 At 6 19 27 PM"
  style={{ width:"30%" }}
/>
