...
- Comparing several products or features across multiple dimensions (e.g., performance, cost, reliability)
...
<Steps>
  <Step title="Select an integration">
    Click `Integrate` in the top menu and choose Airtable, Notion or another [integration](/integrations).
  </Step>
  <Step title="Add a Choice matrix field">
