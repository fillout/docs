...
<Steps>
  <Step title="Connect your Fillout form to Excel">
    ...
    You will be redirected to Microsoft's login page. Sign in, and click `Accept` to allow Fillout to create a new sheet that will automatically be populated with form responses.
  </Step>
  ...
  <Step title="Publish and share your form">
    That's it! Once you're done with the setup, you're good to go. Click `Publish` on the upper right corner, then share your form. Every time someone submits your form, a new row will be created with their answers.
  </Step>
</Steps>
