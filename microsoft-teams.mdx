...
<Steps>
  <Step title="Link your Fillout form to Teams">
    ...
    You will be redirected to Microsoft's login page. Sign in with your account to continue, then click `Accept` to allow Fillout to send notifications to your channels in Teams.
  </Step>
