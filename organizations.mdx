...
<Warning>
  This will permanently delete all workspaces, forms, apps, and databases. They **cannot be recovered**. If you need any of these, we recommend [exporting](https://www.fillout.com/help/importing-and-exporting-forms#export-a-form) them before deleting.
</Warning>
