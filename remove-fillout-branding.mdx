...
| Remove **Made with Fillout** button on all pages | <Icon icon="xmark" iconType="solid" color="#FFC738" /> | Light branding | <Icon icon="check" iconType="solid" color="#FFC738" /> |
...
The "Made with Fillout, the easy way to make stunning forms" text can be manually edited to your preferred text or deleted altogether.
