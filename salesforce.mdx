...
<Steps>
  <Step title="Connect your form to Salesforce">
    ...
    Click `Connect to Salesforce` to sign in with your Salesforce account. Then, choose an **object** where you would like to store responses.
  ...
  <Step title="Map your form fields">
    ...
    Alternatively, you can go to the Salesforce connection in the `Integrate` page and [manually map](https://www.fillout.com/help/additional-integration-mappings#how-to-map-fields-manually) them. `+ Add new` Salesforce field on the left and select the corresponding Fillout field on the right.
