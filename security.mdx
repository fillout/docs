...
This Security Practices page describes the administrative, technical and physical controls applicable to Zite. If you have additional questions regarding security, please contact [security@fillout.com](mailto:security@fillout.com) and we will respond as soon as possible.
...
You can email [security@fillout.com](mailto:security@fillout.com) with details on any security vulnerabilities you discover. Zite operates a security bug bounty program. Security researchers around the world continuously test the security of Zite's services, and report issues via the program.