...
description: "Let respondents select Airtable linked records from a Fillout form. Optionally filter records based on prior inputs."
icon: "folder"
sidebarTitle: "Pick Linked Records"
---
