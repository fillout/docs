...
<Steps>
  <Step title="Add a table field">
    On the left-hand panel, look for the `Table` field. Click `+ Add column` to ask a question or request information.
  ...
  <Step title="Publish and share your form">
    ...
    <Warning>
      Connecting the table field to an [integration](/integrations) is currently not supported. However, responses can be viewed in a modal on the Results page.
    </Warning>
  </Step>
</Steps>
