...
If you are an admin, you can choose a default theme for all new forms in your organization. Learn how it works [here](https://www.fillout.com/help/default-theme).

## Related articles

<CardGroup cols={3}>
  <Card title="Advanced designer" color="#FFC738" icon="paintbrush-pencil" iconType="regular" href="/advanced-designer">
    Add a custom CSS, edit button style, change text padding, and more.
  </Card>

  <Card title="Change fonts" color="#FFC738" icon="font-case" iconType="regular" href="/form-fonts">
