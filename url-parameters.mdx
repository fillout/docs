...
<Steps>
  ...
  <Step title="Reference the parameter in your form">
    ...
    To prefill a hidden field, set the parameter as the **Default value**.

    <Frame>
      ![Screenshot 2026 08 19 At 3 29 59 PM](/images/Screenshot-2026-08-19-at-3.29.59-PM.png "Screenshot 2026 08 19 At 3 29 59 PM")
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Publish and share your form link">
    By default, respondents will see a language picker. Whichever language they select will be automatically recorded as the language parameter
  </Step>
</Steps>

**Track the form language used in responses**

In some cases, it can be useful to record which language a respondent used when answering your form. Follow the [steps above](/url-parameters#how-to-add-a-url-parameter-or-hidden-field).
