...
For example: [https://form.fillout.com/abc123?name=Jane&email=jane@example.com](https://form.fillout.com/abc123?name=Jane&email=jane@example.com)

Here, **name=Jane** and **email=[jane@example.com](mailto:jane@example.com)** are URL parameters.
...
- [Write to any integration](/url-parameters#map-it-to-your-integration-field) with mappings
...
<Steps>
  ...
  <Step title="Reference the parameter in your form">
    There are many [ways you can use URL parameters](/url-parameters#how-url-parameters-work). In this example, we'll show a respondent's `name` at the beginning of the form.
...
In some cases, it can be useful to record which language a respondent used when answering your form. Follow the steps above.
