...
You can also write these URL parameters to your database or other types of integrations by [mapping](https://www.fillout.com/help/additional-integration-mappings#how-to-map-fields-manually) them. They are typically found when you click the `link icon` <Icon icon="link" /> in the picker.
