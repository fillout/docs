...
- [Write data to any integration](/url-parameters#send-url-parameters-to-integrations) with mappings
...
You can pass data from a main form to a subform using URL parameters so respondents won't need to re-enter the same information. Check out [this guide](/url-parameters-between-forms#how-to-send-data).
