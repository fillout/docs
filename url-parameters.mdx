...
- [Write to any integration](https://www.fillout.com/help/url-parameters#map-it-to-your-integration-field) with mappings
...
<Tabs>
  <Tab title="Set it as a default value">
    ...
    In some cases, it can be useful to record which language a respondent used when answering your form. Follow the [steps above](/embedded-url-parameters#how-to-add-a-url-parameter-or-hidden-field) to create a URL parameter called `lang`, then set `lang` as the field's **Default value**.
  </Tab>
