...
User Groups let admins bundle team members together and grant them workspace, form, or app access all at once. Instead of assigning permissions to each member individually, you can manage access for an entire group in one place.
