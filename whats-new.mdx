...
<Update label="April 2026" tags={["Zite"]}>
  ...
  <p style={{ fontSize: "16px" }}>
    We’re adding three new useful features to Zite: QR codes for business workflows, Groups for managing access at scale, and Secrets for storing private integration values securely.
  </p>

  #### 🔗 Generate QR codes in your app

  <p style={{ fontSize: "16px" }}>
    Tell the Agent how you’d like a QR code to work, and Zite will generate it for you on demand through your app logic. QR codes are free to create and are not stored in your database.
  </p>
  ...
  <p style={{ fontSize: "16px" }}>
    Organizations can grant top-level Use or Edit access to a department or a group of people at once, without updating each person individually. Groups are available from `Settings` -> `Groups`.
  </p>
