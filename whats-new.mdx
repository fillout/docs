...
<Update label="April 2026" tags={["Zite"]}>
  ...
  Integrate Zite to data sources, payment providers, automation tools, and custom APIs to extend your apps and workflows. Keep your existing systems in sync while extending your internal apps and workflow.

  <Frame>
    <img
      src="/images/whatsnew/integrations.webp"
      alt="Popular Zite integrations including Zite Database, Google Sheets, Airtable, Slack, OpenAI, and Email"
    />
  </Frame>

  ### Popular integrations

  - **Zite Database**: Connect directly to native Zite tables to power app screens, workflows, and real-time internal tools.
  - **Google Sheets**: Sync spreadsheet data with your app so teams can keep working in Sheets while Zite handles UI and logic.
  - **Airtable**: Use Airtable as a live backend for records, then read and write data from Zite apps and workflows.
  - **Slack**: Send updates and trigger actions in Slack so teams can review and respond to app events in their existing channels.
  - **OpenAI**: Add AI-powered summarization, classification, and content generation directly into your app workflows.
  - **Email (Beta)**: Send transactional and workflow emails from your app for confirmations, reminders, and follow-ups.
