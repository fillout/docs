...
No user login is required to call this endpoint — just an API key.
...
Generate or view your API key in the [Developer settings](https://build.fillout.com/home/settings/developer) tab of your account.
