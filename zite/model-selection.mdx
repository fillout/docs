...
| Model         | Speed | Intelligence | AI Credits | Best for                           |
| :------------ | :---: | :----------: | ---------- | :--------------------------------- |
...
<Info>
  Different models consume AI credits at different rates based on their underlying AI costs. For more details on AI credits and usage, check out the [AI Credits guide](/zite/credits).
</Info>
