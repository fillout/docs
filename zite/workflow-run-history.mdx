---
title: "Zite Workflow run history"
...
<CardGroup cols={3}>
  ...
  <Card color="#FFC738" icon="plug" iconType="regular" href="/zite/integrations" title="Connect to integrations">
    Link your accounts and use external services.
  </Card>
  <Card color="#FFC738" icon="wrench" iconType="regular" href="/zite/tips/troubleshooting" title="Troubleshooting">
